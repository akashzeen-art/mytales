...
const StoryModal = ({ isOpen, onClose, category, preferredTitle, rawText }) => {
  ...
  const filteredVoices = useMemo(() => {
    return voices.filter(v => {
      ...
      return ((name.includes('google') && name.includes('uk') && name.includes('male') && lang === 'en-gb') ||
              (name.includes('google') && name.includes('uk') && name.includes('female') && lang === 'en-gb'));
    });
  }, [voices]);
    ...
    <div className={styles.backdrop} role="dialog" aria-modal="true">
      <div className={styles.modal}>
        ...
        <div className={styles.controls}>
          ...
          <div className={styles.controlGroup}>
            <label className={styles.label}>Text Speed</label>
            <input
              type="range"
              min="4"
              max="40"
